...
global dfr 
dfr = get_reddit(cid= r_cid, csec= r_csec, uag= r_uag)
...
def update_table(page_current, page_size, sort_by, filter, n_clicks):
        ...
        if n_clicks is None:
                ...
                dff = get_reddit(cid= r_cid, csec= r_csec, uag= r_uag)
...
'''
# Use this instead to enter debug mode
if __name__ == '__main__':
